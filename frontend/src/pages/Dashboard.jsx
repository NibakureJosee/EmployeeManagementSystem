                    ...
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <select
                          ...
                          id="first-name"
                          className="mt-1 block w-full py-2 px-3 border border-blue-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        >
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <input
                          ...
                          type="text"
                          id="password"
                          className="mt-1 focus:ring-indigo-100 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                      </div>
                    </div>
                  </div>
